...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Sun Nov 18 01:22:02 2012
...
moc_mainwindow.cpp: ui/mainwindow.h
	/usr/local/Trolltech/Qt-4.8.3/bin/moc $(DEFINES) $(INCPATH) ui/mainwindow.h -o moc_mainwindow.cpp

moc_outsidedialog.cpp: ui/outsidedialog.h
	/usr/local/Trolltech/Qt-4.8.3/bin/moc $(DEFINES) $(INCPATH) ui/outsidedialog.h -o moc_outsidedialog.cpp
...
ui_mainwindow.h: ui/mainwindow.ui
	/usr/local/Trolltech/Qt-4.8.3/bin/uic ui/mainwindow.ui -o ui_mainwindow.h

ui_outsidedialog.h: ui/outsidedialog.ui
	/usr/local/Trolltech/Qt-4.8.3/bin/uic ui/outsidedialog.ui -o ui_outsidedialog.h
